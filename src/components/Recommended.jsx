...
import { BsEye, BsGraphUp, BsSearch, BsPencil, BsPlusCircle, BsFileText, BsFillPeopleFill, BsArrowRight  } from "react-icons/bs";
        ...
        <Card.Body>
          ...
          <Card className="border-0 shadow-sm">
            <Card.Body>
              ...
              <Button variant="outline-secondary" className="rounded-pill">Aggiungi un riepilogo</Button>
            </Card.Body>
          </Card>
        </Card.Body>
      </Card>
        ...
        <Card.Body>
          ...
          <Row>
            ...
            <Col md={4} className="text-center mb-3">
              ...
              <p className="text-muted small">Crea un post per aumentare l'interesse.<br />Ultimi 7 giorni</p>
            </Col>
            <Col md={4} className="text-center mb-3">
              <div>
          ...
          <Button variant="link" className="w-100 p-0 mt-2 text-muted">Mostra tutte le analisi<BsArrowRight />
          </Button>
      ...
      <Card className="mb-4 border-0 shadow-sm">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <Button
  variant="light"
  className="rounded-pill text-primary border border-primary"
>
  Crea un post
</Button>
          ...
          <Button variant="link" className="w-100 p-0 text-muted">Mostra tutte le attività <BsArrowRight /></Button>
        </Card.Body>
      </Card>
    </Container>
  );
